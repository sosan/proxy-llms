...
import { readNumbered, READ_NUMBERED_LINE_RE } from "./filters/readNumbered.ts";
import { searchList, SEARCH_LIST_HEADER_RE } from "./filters/searchList.ts";
import type { FilterFn } from "../../interfaces/rtk.ts";
